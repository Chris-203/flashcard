...
const ResultPage = () => {
  ...
  //fetches the checkout session data from our API when the component mounts or when the `session_id` changes. It updates the component’s state based on the API response
  useEffect(() => {
